---
title: Legacy Develop / V2 / Teamtest
type: cloud-api
tags: [Places, Team Create]
---

# Legacy Develop / V2 / Teamtest
...
|--------|------|-------------|
| `DELETE` | `/legacy-develop/v2/teamtest/{placeId}` | Close a game instance that is being used for team testing |
