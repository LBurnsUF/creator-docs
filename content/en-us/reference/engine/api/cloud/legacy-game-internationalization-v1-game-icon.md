---
title: Legacy Game Internationalization / V1 / Game Icon
type: cloud-api
...
|--------|------|-------------|
| `GET` | `/legacy-game-internationalization/v1/game-icon/games/{gameId}` | Get all icons for a game |
| `DELETE` | `/legacy-game-internationalization/v1/game-icon/games/{gameId}/language-codes/{languageCode}` | Delete a localized icon from a game |
| `POST` | `/legacy-game-internationalization/v1/game-icon/games/{gameId}/language-codes/{languageCode}` | Update a game's icon |
