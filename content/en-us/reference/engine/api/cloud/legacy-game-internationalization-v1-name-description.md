---
title: Legacy Game Internationalization / V1 / Name Description
type: cloud-api
tags: [Localization, Universes]
---

# Legacy Game Internationalization / V1 / Name Description
...
|--------|------|-------------|
| `POST` | `/legacy-game-internationalization/v1/name-description/games/translation-history` | Gets the history for name or description in a provided language. |
| `PATCH` | `/legacy-game-internationalization/v1/name-description/games/{gameId}` | Updates a game's name and/or description in multiple languages. |
