...
|--------|------|-------------|
| `GET` | `/v1/assetId/{assetId}` | Retrieves an asset by its ID |
| `GET` | `/v1/assetId/{assetId}/version/{versionNumber}` | Retrieves an asset by its ID and version number. |
...
- `assetId` (path, integer (required)) - The ID of the asset to retrieve.
- `versionNumber` (path, integer (required)) - The version of the asset to retrieve.
- `Accept-Encoding` (header, string (required)) - 
- `Roblox-Place-Id` (header, integer (required)) - 
- `AssetType` (header, string (required)) - 
- `Accept` (header, string (required)) - 
