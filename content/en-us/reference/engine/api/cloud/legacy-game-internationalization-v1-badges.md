---
title: Legacy Game Internationalization / V1 / Badges
type: cloud-api
tags: [Badges, Localization]
---

# Legacy Game Internationalization / V1 / Badges
...
|--------|------|-------------|
| `PATCH` | `/legacy-game-internationalization/v1/badges/{badgeId}/description/language-codes/{languageCode}` | Update localized description of a badge |
| `GET` | `/legacy-game-internationalization/v1/badges/{badgeId}/icons` | Get all icons for a badge |
| `DELETE` | `/legacy-game-internationalization/v1/badges/{badgeId}/icons/language-codes/{languageCode}` | Delete a localized icon from a badge |
| `POST` | `/legacy-game-internationalization/v1/badges/{badgeId}/icons/language-codes/{languageCode}` | Update a badge's icon |
| `GET` | `/legacy-game-internationalization/v1/badges/{badgeId}/name-description` |  |
| `DELETE` | `/legacy-game-internationalization/v1/badges/{badgeId}/name-description/language-codes/{languageCode}` | Delete localized name and description of a badge |
| `PATCH` | `/legacy-game-internationalization/v1/badges/{badgeId}/name-description/language-codes/{languageCode}` | Update localized name and description of a badge |
| `PATCH` | `/legacy-game-internationalization/v1/badges/{badgeId}/name/language-codes/{languageCode}` | Update localized name of a badge |
