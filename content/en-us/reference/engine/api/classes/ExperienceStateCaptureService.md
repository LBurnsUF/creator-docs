...
| `Class.ExperienceStateCaptureService.SelectionMode` | `Enum.ExperienceStateCaptureSelectionMode` | [Hidden] [NotReplicated] {security: RobloxScriptSecurity} |
...
### `Class.ExperienceStateCaptureService.ItemSelectedInCaptureMode`
