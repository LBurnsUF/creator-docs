...
|----------|------|-------------|
| `DateTime.UnixTimestamp` | `number` | The number of **seconds** between January 1st, 1970 at 00:00 UTC (the Unix epoch). |
| `DateTime.UnixTimestampMillis` | `number` | The number of **milliseconds** between January 1st, 1970 at 00:00 UTC (the Unix epoch). |
